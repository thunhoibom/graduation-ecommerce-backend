...
/**
 * Cash on delivery: no external gateway. Checkout only stores a reference token;
 * {@code OrdersProcessService} records PAID when the shipment is completed (cash collected).
 */
@Service("COD")
