...
public class ProductDocument {
    ...
    @MultiField(
        mainField = @Field(
            ...
            searchAnalyzer = "standard_vietnamese_search",
            copyTo = "all"
        ),
        otherFields = {
    ...
    /**
     * Units sold in paid, fulfilled customer orders (all-time). Indexed for {@code function_score} ranking.
     */
    @Field(type = FieldType.Integer)
    private Integer unitsSold;

    /**
     * Count of {@code PRODUCT_VIEW} behavior events referencing this product. Indexed for ranking.
     */
    @Field(type = FieldType.Integer)
