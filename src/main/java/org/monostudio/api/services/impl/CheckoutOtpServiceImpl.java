...
public class CheckoutOtpServiceImpl implements CheckoutOtpService {
    ...
    @Override
    public CheckoutOtpInitiateResponse issueOtpForOrder(Order order, String checkoutEmail) throws BadInputException {
        String email = resolveOtpDestinationEmail(checkoutEmail);
    ...
    @Override
    public CheckoutOtpInitiateResponse resendOtpForOrder(Long orderId, String checkoutEmail) throws BadInputException {
    ...
    private String resolveOtpDestinationEmail(String checkoutEmail) throws BadInputException {
        if (StringUtils.isBlank(checkoutEmail)) {
            throw new BadInputException("Checkout form email is required for OTP");
        }
