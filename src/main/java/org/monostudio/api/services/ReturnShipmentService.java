...
public interface ReturnShipmentService {
    ...
    /**
     * Manually retry GHN return-shipment dispatch for a specific return request.
     * This is intended for operator-driven recovery after a FAILED_PERMANENT queue entry.
     *
     * @param returnRequestId ID of the return request to retry
     */
    void retryReturnShipmentCreation(Long returnRequestId);
