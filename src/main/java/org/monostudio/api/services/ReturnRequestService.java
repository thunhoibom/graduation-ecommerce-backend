...
public interface ReturnRequestService {
    ...
    /**
     * Records warehouse QC after returned goods are received.
     * Restores sellable stock only when QC passes.
     */
    ReturnRequestPojo submitQc(
        Long id,
        String result,
        String qcNotes,
        String qcPhotoUrls
     ...
     * @throws BadInputException When the return request is not in a valid state
     */
    ReturnRequestPojo completeRefund(
        Long id,
        String adminNotes,
