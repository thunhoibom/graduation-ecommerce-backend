...
public class DataShippingMethodsController
    ...
    @PreAuthorize("hasAuthority('shipping-methods:create') or hasAuthority('shippers:create')")
    @CacheEvict(cacheNames = CacheNames.PUBLIC_SHIPPING_METHODS, allEntries = true)
    public void create(@RequestBody ShippingMethodPojo input)
    ...
    @PreAuthorize("hasAuthority('shipping-methods:update') or hasAuthority('shippers:update')")
    @CacheEvict(cacheNames = CacheNames.PUBLIC_SHIPPING_METHODS, allEntries = true)
    public void update(@RequestBody ShippingMethodPojo input, @PathVariable Long id)
    ...
    @ResponseStatus(NO_CONTENT)
    @PreAuthorize("hasAuthority('shipping-methods:delete') or hasAuthority('shippers:delete')")
    @CacheEvict(cacheNames = CacheNames.PUBLIC_SHIPPING_METHODS, allEntries = true)
