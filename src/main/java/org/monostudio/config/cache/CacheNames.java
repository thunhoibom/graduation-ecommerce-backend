...
public final class CacheNames {
    ...
    public static final String PUBLIC_PRODUCTS_LIST = "publicProductsList";
    public static final String PUBLIC_PRODUCT_DETAIL = "publicProductDetail";
    public static final String PUBLIC_CATEGORY_TREE = "publicCategoryTree";
    ...
    public static final String ADMIN_LOW_STOCK = "adminLowStock";
    public static final String ADMIN_ORDER_STATUS_BREAKDOWN = "adminOrderStatusBreakdown";
}
