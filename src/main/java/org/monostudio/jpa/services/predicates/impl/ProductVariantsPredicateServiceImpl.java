        ...
        for (Map.Entry<String, String> entry : queryParamsMap.entrySet()) {
            ...
            try {
                switch (paramName) {
                    ...
                    case "query":
                        predicate.and(
                            BASE_PATH.sku.likeIgnoreCase("%" + stringValue + "%")
                                .or(BASE_PATH.size.likeIgnoreCase("%" + stringValue + "%"))
                                .or(BASE_PATH.color.likeIgnoreCase("%" + stringValue + "%"))
                                .or(BASE_PATH.barcode.likeIgnoreCase("%" + stringValue + "%"))
                        );
                        break;
                    case "barcode":
