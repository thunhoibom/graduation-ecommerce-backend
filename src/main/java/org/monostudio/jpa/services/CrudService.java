...
public interface CrudService<M, E> {
    ...
    /**
     * Queries a paged collection of registries in the form of a {@link org.monostudio.api.models.DataPagePojo}.
     *
     ...
     * {@link org.monostudio.jpa.services.PredicateService} to create the Predicate for it in the first place.
     *
     * @param filters Filtering conditions
     ...
     * Predicates can be produced using a {@link org.monostudio.jpa.services.PredicateService}.
     * <br/>
     ...
     * {@link com.querydsl.core.types.Predicate}.<br/>
     * It is usually the task of the {@link org.monostudio.jpa.services.PredicateService}
