...
public class ReturnRequest
    ...
    @Column(name = "return_request_refund_bank_name")
    @Size(max = 255)
    private String refundBankName;

    @Column(name = "return_request_refund_bank_account_number")
    @Size(max = 64)
    private String refundBankAccountNumber;

    @Column(name = "return_request_refund_bank_account_holder")
    @Size(max = 255)
    private String refundBankAccountHolder;

    @Column(name = "return_request_refund_proof_url")
    @Size(max = 1024)
    private String refundProofUrl;

    @Column(name = "return_request_refund_reference")
    @Size(max = 255)
    private String refundReference;

    @Column(name = "return_request_refunded_at")
    private Instant refundedAt;

    @Enumerated(EnumType.STRING)
    @Column(name = "return_request_qc_status")
    private QcStatus qcStatus;

    @Column(name = "return_request_qc_notes")
    @Size(max = 2000)
    private String qcNotes;

    @Column(name = "return_request_qc_photo_urls")
    @Size(max = 2048)
    private String qcPhotoUrls;

    @Column(name = "return_request_qc_completed_at")
    ...
    public ReturnRequest(ReturnRequest source) {
        ...
        this.refundBankName = source.refundBankName;
        this.refundBankAccountNumber = source.refundBankAccountNumber;
        this.refundBankAccountHolder = source.refundBankAccountHolder;
        this.refundProofUrl = source.refundProofUrl;
        this.refundReference = source.refundReference;
        this.refundedAt = source.refundedAt;
        this.qcStatus = source.qcStatus;
        this.qcNotes = source.qcNotes;
        this.qcPhotoUrls = source.qcPhotoUrls;
        this.qcCompletedAt = source.qcCompletedAt;
        this.order = null;
    }
