...
public class MailingProperties {
    ...
    /**
     * Optional override for contact form notifications; if blank, {@link #ownerEmail} is used.
     */
    private String contactInquiryNotificationTo;
    private String contactInquirySubject;
}
